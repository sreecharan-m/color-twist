...
const end={
    ...
    draw(){
        ...
        ctx.closePath();*/
            ...
            ctx.lineWidth = 1.5;
            ctx.font = "40px Teko";
            ctx.fillText("game over reload the page", WIDTH/2, HEIGHT/2);
            ctx.strokeText("game over reload the page", WIDTH/2, HEIGHT/2);
            ctx.closePath();

            ctx.beginPath();
            ctx.lineWidth = 1.5;
            ctx.font = "30px Teko";
            ctx.fillText("score", 300, 400);
            ctx.strokeText("score", 300, 400);
            ctx.closePath();

            ctx.beginPath();
            ctx.lineWidth = 1.5;
            ctx.font = "30px Teko";
            ctx.fillText(score.scr, 350, 400);
            ctx.strokeText(score.scr, 350, 400);
            ctx.closePath();
