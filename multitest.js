...
const endm={
    ...
    draw(){
        ...
        ctx2.strokeText("Game is Over...Reload The Page",WIDTH/2,HEIGHT/2);*/
            ...
            ctx2.lineWidth = 1.5;
            ctx2.font = "40px Teko";
            ctx2.fillText("gameover reload the page", WIDTH/2, HEIGHT/2);
            ctx2.strokeText("gameover reload the page",WIDTH/2, HEIGHT/2);
            ctx2.closePath();

            ctx2.beginPath();
            ctx2.lineWidth = 1.5;
            ctx2.font = "30px Teko";
            ctx2.fillText("score", 300, 400);
            ctx2.strokeText("score", 300, 400);
            ctx2.closePath();

            ctx2.beginPath();
            ctx2.lineWidth = 1.5;
            ctx2.font = "30px Teko";
            ctx2.fillText(scorem.scr, 350, 400);
            ctx2.strokeText(scorem.scr, 350, 400);
            ctx2.closePath();
